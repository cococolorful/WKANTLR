...
public:
  ...
  virtual void enterTypename(CPP14Parser::TypenameContext *ctx) = 0;
  virtual void exitTypename(CPP14Parser::TypenameContext *ctx) = 0;
  ...
  virtual void enterTypeid(CPP14Parser::TypeidContext *ctx) = 0;
  virtual void exitTypeid(CPP14Parser::TypeidContext *ctx) = 0;
  ...
  virtual void enterRightShift(CPP14Parser::RightShiftContext *ctx) = 0;
  virtual void exitRightShift(CPP14Parser::RightShiftContext *ctx) = 0;

  virtual void enterRightShiftAssign(CPP14Parser::RightShiftAssignContext *ctx) = 0;
  virtual void exitRightShiftAssign(CPP14Parser::RightShiftAssignContext *ctx) = 0;

  virtual void enterOperator(CPP14Parser::OperatorContext *ctx) = 0;
  virtual void exitOperator(CPP14Parser::OperatorContext *ctx) = 0;
